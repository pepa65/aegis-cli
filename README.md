...
```
wget https://github.com/pepa65/aegis-cli/releases/download/1.3.120/aegis
...
`aegis aegis-backup-20230512-1.3.1200.json`
...
### Help
```
aegis-cli 1.3.120 - Show TOTPs from Aegis vault on CLI
